...
ZEND_API zend_script *compile_file(zend_file_handle *file_handle, int type);
ZEND_API zend_script *compile_string(zval *source_string, char *filename);
ZEND_API zend_script *compile_filename(int type, zval *filename);
